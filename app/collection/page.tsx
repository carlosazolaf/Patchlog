...
export default function CollectionPage() {
  ...
  const [statusFilter, setStatusFilter] = useState(() => {
    if (typeof window !== 'undefined') {
      return sessionStorage.getItem('collection_statusFilter') || 'all'
    }
    return 'all'
  })
  ...
  const [brandFilter, setBrandFilter] = useState(() => {
    if (typeof window !== 'undefined') {
      return sessionStorage.getItem('collection_brandFilter') || 'all'
    }
    return 'all'
  })
  ...
  const [modelFilter, setModelFilter] = useState(() => {
    if (typeof window !== 'undefined') {
      return sessionStorage.getItem('collection_modelFilter') || 'all'
    }
    return 'all'
  })
  ...
  const [typeFilter, setTypeFilter] = useState(() => {
    if (typeof window !== 'undefined') {
      return sessionStorage.getItem('collection_typeFilter') || 'all'
    }
    return 'all'
  })
  ...
  const [subtypeFilter, setSubtypeFilter] = useState(() => {
    if (typeof window !== 'undefined') {
      return sessionStorage.getItem('collection_subtypeFilter') || 'all'
    }
    return 'all'
  })
  ...
  // Restaurar posición de scroll al re-renderizar pedales cargados
  useEffect(() => {
    if (pedals.length > 0) {
