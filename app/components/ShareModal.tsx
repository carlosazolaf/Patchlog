...
export default function ShareModal({ username, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed inset-x-4 top-1/2 z-50 mx-auto max-w-md -translate-y-1/2 rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl">
        {/* Header */}
        ...
        {/* URL display */}
        <div className="mb-4 flex items-center gap-2 rounded-xl border border-zinc-800 bg-zinc-950 px-3 py-2.5">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={!username}
            className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-zinc-800 bg-zinc-950 py-2.5 text-sm text-zinc-400 transition-colors hover:border-zinc-700 hover:text-zinc-200 disabled:cursor-not-allowed disabled:opacity-40"
          >
