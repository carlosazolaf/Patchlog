          ...
          <div className="flex items-start justify-between mb-4 gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <Link
                href="/settings"
                aria-label="Settings"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-[#c8beb1] bg-[#faf7f2] text-[#5b544c] transition-colors hover:bg-[#f3efe8]"
              >
                <svg
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-[#c8beb1] bg-[#faf7f2] px-4 py-2 text-sm text-[#5b544c] transition-colors hover:bg-[#f3efe8]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="14"
